...
5. **Custom Foundation Rules:** By subclassing the default timber model creator, they implemented specific rules to automatically identify foundation beams (beams lying horizontally near `z=0`), assign them a stronger 110x120 cross-section, and apply specific structural joints.
